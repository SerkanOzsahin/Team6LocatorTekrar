...
public class Odev5 extends BaseDriver {
    ...
    public void Test1(){
        ...
        for (int i = 0; i <= 4; i++) {
            ...
            actions.click(calculate).build().perform();
    ...
    public void Test4(){
        ...
        Assert.assertTrue("Buton Tıklanabilir değil ",afterEnableBtn.isEnabled());
   ...
   //2) “Visible After 5 seconds” butonunun gorunur oldugunu test edin
    ...
    public void Test5(){
        ...
        wait.until(ExpectedConditions.elementToBeClickable(visibleBtn));
        Assert.assertTrue("Buton Tıklanabilir değil ",visibleBtn.isEnabled());
